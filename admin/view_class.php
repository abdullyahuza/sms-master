                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                if($rowCount < 1){
                                                    ...
                                                    echo "<script>window.location.href='all_classes.php'</script>";
                                                }
                                                ...
                                                <table class="table table-striped table-bordered dataTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <center>
                                                                    <a href="./confirm_class_result.php?class=<?php echo $_GET['class'] ?>" class="btn btn-primary btn-sm">Process class result</a>
                                                                </center>
                                                            </td>
                                                        </tr>
